...
2. Bapak Ir. Win Rizal, M.E. selaku Kepala BPS Provinsi Bengkulu; //Ganti ini
3. #namaCoach, selaku Coach yang telah membimbing dan memberikan motivasi selama proses aktualisasi.
...
#align(right)[#block(width: auto, align(center)[
  #kotaPeserta, #submissionDate \
  Peserta, \
  #v(2cm)
  #text(weight: "bold")[#underline[#nama]] \
  NIP. #nip
])]
